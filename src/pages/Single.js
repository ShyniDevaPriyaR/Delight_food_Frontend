...
// this page is only for database 
...
const Single = () => {
    ...
    const fetchUsers = () => {
      axios.get('http://localhost:6002/sin')
    ...
    const createUser = () => {
      ...
      axios.post('http://localhost:6002/single', userData)
        .then(res => {
    ...
    const updateUser = (userId) => {
      axios.put(`'http://localhost:6002/sing'/${userId}`, { name: username, email: email, phone: phone })
        .then(res => {
    ...
    const deleteUser = (userId) => {
      axios.delete(`'http://localhost:6002/singlde'/${userId}`)
        .then(() => {
